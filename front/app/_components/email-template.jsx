	...
	<Html>
		...
		<Body style={main}>
			<Container style={container}>
				<Img
					src='https://res.cloudinary.com/dvqhmeydt/image/upload/v1725028409/small_4351794_0bd8_41d2b19e1c.jpg'
					width="420"
					height="300"
					alt="Koala"
					style={logo}
				...
				<Text style={paragraph}>
					Thank you purchasing on Tarek Tech Ecommerce. Click on Below download button to download the all digital content
				</Text>
